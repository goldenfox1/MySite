...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		$data['title'] = $this->document->getTitle();
					...
					$this->document->addScript('catalog/view/javascript/retina-1.3.0/retina.min.js');
		...
		$data['theme'] = $this->config->get('basecart_theme');
		$data['nav'] = $this->config->get('basecart_nav');
