...
//quicksave end
	...
	protected function getForm() {
                ...
                $this->document->addScript('view/javascript/mms.multiselect.js');
                $data['button_multiselect'] = $this->language->get('button_multiselect');
...
//quicksave end
		...
		$data['layouts'] = $this->model_design_layout->getLayouts();
			...
			// GF-AdminProductCommentTab start
				$data['review'] = $this->load->controller('catalog/review_tab');	
			// GF-AdminProductCommentTab end
