...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/productmanage')) {
					$catalog[] = array(
						'name'     => $this->language->get('text_productmanage'),
						'href'     => $this->url->link('catalog/productmanage', 'user_token=' . $this->session->data['user_token'], true),
						'children' => array()       
					);
				}
...
if ($marketing) {
				$data['menus'][] = array(
					...
					'name'	   => $this->language->get('text_bcim'),
