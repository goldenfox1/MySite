...
class ModelSaleOrder extends Model {
	...
	public function getOrderProducts($order_id) {
				...
				$query = $this->db->query("SELECT o.* , p.image, l.link FROM " . DB_PREFIX . "order_product o LEFT JOIN " . DB_PREFIX . "product p ON p.product_id =o.product_id LEFT JOIN " . DB_PREFIX . "product_link l ON l.product_id =o.product_id WHERE o.order_id = '" . (int)$order_id . "'");
