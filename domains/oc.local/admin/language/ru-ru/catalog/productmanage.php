<?php
// Heading
$_['heading_title']          = 'Товарный менеджер';
...
$_['button_assign_to_category']        = 'Добавить в категорию';
$_['button_remove_to_category']        = 'Удалить из категории';
$_['entry_select_category']        = 'Выбрать категорию';
$_['column_category']        = 'Категория';
$_['button_enable']            = 'Включить/Отключить';

// Help
$_['help_keyword']           = 'Не используйте пробелы, замените их на тире (-) и убедитесь, что ключевое слово уникально для всего сайта.';
